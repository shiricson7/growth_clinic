...
export default function GrowthPercentileChart({
  ...
  return (
    <div
      className={`relative w-full rounded-3xl border border-slate-200/70 bg-white/80 p-5 shadow-sm backdrop-blur dark:border-slate-700/70 dark:bg-slate-900/80 ${
        isReport ? "p-6" : ""
      } [--chart-observed:#1d4ed8] [--chart-observed-soft:rgba(59,130,246,0.22)] [--chart-median:#64748b] [--chart-band-1:rgba(99,102,241,0.15)] [--chart-band-2:rgba(59,130,246,0.2)] [--chart-gh:rgba(34,197,94,0.25)] [--chart-gh-text:#15803d] [--chart-gnrh:rgba(249,115,22,0.25)] [--chart-gnrh-text:#c2410c] dark:[--chart-observed:#93c5fd] dark:[--chart-observed-soft:rgba(147,197,253,0.25)] dark:[--chart-median:#94a3b8] dark:[--chart-band-1:rgba(129,140,248,0.18)] dark:[--chart-band-2:rgba(96,165,250,0.22)] dark:[--chart-gh:rgba(34,197,94,0.18)] dark:[--chart-gh-text:#86efac] dark:[--chart-gnrh:rgba(249,115,22,0.2)] dark:[--chart-gnrh-text:#fdba74]`}
    >
